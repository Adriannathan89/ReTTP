//! Lexical and syntactic front end for the Rettp DSL.
//!
...
//! converts a valid tree into a domain [`rettp_domain::TestSuite`]. HTTP I/O
...
//!
//! ```
//! use rettp_parser::{SourceText, ValidationContext, lex, parse, validate_and_convert};
//!
...
/// Lexical analysis and token definitions for the Rettp DSL.
pub mod lexer;
