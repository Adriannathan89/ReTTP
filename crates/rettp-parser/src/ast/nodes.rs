//! Syntax tree nodes produced by the Rettp parser.
//!
...
/// Root node for one Rettp source file.
///
...
/// A top-level block in a Rettp suite.
#[derive(Debug, Clone, PartialEq)]
pub enum BlockAst {
...
/// JSON-like literal value represented in the Rettp syntax tree.
///
