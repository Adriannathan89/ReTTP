...
fn empty_report_uses_source_name_and_zero_counts() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "<testsuites name=\"empty.utest\" tests=\"0\" failures=\"0\" errors=\"0\" skipped=\"0\" time=\"0.000\">\n",
            "</testsuites>\n",
        )
    );
}
...
fn converted_domain_secrets_never_reach_junit_output() {
    ...
    let output = JunitReporter.render(&RunReport::from_suite_result("safe.utest", &result));
