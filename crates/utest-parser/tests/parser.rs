...
fn parse_source(input: &str) -> utest_parser::ParseResult {
    let source = SourceText::new("parser-test.utest", input);
...
fn error_kinds(result: &utest_parser::ParseResult) -> Vec<&ParserErrorKind> {
