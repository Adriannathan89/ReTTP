...
use utest_domain::{Capture, ExpectedType, ObjectMatchMode};

/// Expected properties of one HTTP response after variable interpolation.
///
/// Unlike [`utest_domain::ResponseExpectation`], this type cannot carry an
/// [`utest_domain::InterpolatedString`]. Week 8 runtime code converts the
